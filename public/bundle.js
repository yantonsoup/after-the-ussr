(function () {
  ...
  function firstPaint() {
    ...
    d3.select(".bar-graphic-container").style('top', halfPageHeight + 'px').style("width", '100%' + "px").style("height", halfPageHeight + "px"); // Use this to set the distance ofo the first step
